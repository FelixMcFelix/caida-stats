...
plot '../results/dirA-1.csv' u 20: xtic(1) title "Dir A" lc palette frac 0.25 fill pattern 1, \
     '../results/dirB-1.csv' u 20 title "Dir B" lc palette frac 0.5 fill pattern 2, \
     '../results/biDir-1.csv' u 20 title "Both" lc palette frac 0.75 fill pattern 7