...
plot '../results/dirA-1.csv' u 12: xtic(1) title "Dir A" lc palette frac 0.25 pattern 1, \
     '../results/dirB-1.csv' u 12 title "Dir B" lc palette frac 0.5 pattern 2, \
     '../results/biDir-1.csv' u 12 title "Both" lc palette frac 0.75 pattern 7